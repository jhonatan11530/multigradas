...
<div id="index-banner" class="parallax-container">
        <div class="section no-pad-bot">
            <div class="container ">
            <br><br><br><br><br><br>
                <h1 class="header center blue-text"><strong>CATÁLOGO REJAS & VALCONES</strong></h1>
            </div>
        </div>
    ...
    <div class="section white">
      <div class="row container">
        <center>
        <h4 class="header"><strong>Catálogo Fotografico de rejas & valcones.</strong></h4>
        </center>
      </div>
    </div>
