...
<div id="index-banner" class="parallax-container">
        <div class="section no-pad-bot">
            <div class="container ">
            <br><br><br><br><br><br>
                <h1 class="header center red-text"><strong>POLITICAS Y PRIVACIDAD</strong></h1>
            </div>
        </div>
        <div class="parallax"><img src="<?php echo get_template_directory_uri(); ?>/iconos/PRIVACIDAD.jpg" alt="Unsplashed background img 1"></div>
    </div>
...
<!-- LA INSTALACIÓN DE LAS GRADAS ES FIRME Y SEGURA. -->  
    <div class="section white">
      <div class="row container">
        <h6>
         <p><strong>Quiénes somos</strong><br><br>
Nuestra dirección de sitio web es: http://localhost/multigradas.<br><br>

<strong>Qué datos personales recopilamos y por qué lo recogemos</strong><br><br>
...
<br><br>
<strong>Formularios de contacto</strong><br><br>
...
<br><br>
<strong>Contenido incrustado de otros sitios web</strong><br><br>
...
<br><br>
<strong>Analítica</strong><br><br>
<strong>Con quién compartimos tus datos</strong><br><br>
...
<br><br>
<strong>Qué derechos tienes sobre tus datos</strong><br><br>
...
<br><br>
<strong>Tu información de contacto</strong><br><br>
